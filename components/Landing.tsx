...
import logo from './logo.png'; // Imported the logo here
...
const Landing: React.FC<LandingProps> = ({ onNavigateToAuth }) => {
  return (
    <div className="flex flex-col min-h-screen bg-gray-900 text-gray-100 items-center justify-center p-6 sm:p-12 overflow-y-auto">
